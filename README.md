...
[![Infrastructure Deployment Status](https://github.com/davidcansler/test-deployment/workflows/Infrastructure/badge.svg)](https://github.com/davidcansler/test-deployment/actions?query=workflow%3A%22Infrastructure%22)
[![Event Processing Pipeline](https://github.com/davidcansler/test-deployment/workflows/Event%20Gather/badge.svg)](https://github.com/davidcansler/test-deployment/actions?query=workflow%3A%22Event+Gather%22)
[![Event Index Pipeline](https://github.com/davidcansler/test-deployment/workflows/Event%20Index/badge.svg)](https://github.com/davidcansler/test-deployment/actions?query=workflow%3A%22Event+Index%22)
[![Web Deployment Status](https://github.com/davidcansler/test-deployment/workflows/Web%20App/badge.svg)](https://davidcansler.github.io/test-deployment)
[![Repo Build Status](https://github.com/davidcansler/test-deployment/workflows/Build%20Main/badge.svg)](https://github.com/davidcansler/test-deployment/actions?query=workflow%3A%22Build+Main%22)
...
This repo serves the municipality: **Test Deployment**
...
fireo.connection(client=Client(
    project="cdp-test-deployment-kqrrrpnk",
...
fs = GCSFileSystem(project="cdp-test-deployment-kqrrrpnk", token="anon")
...
in the
[admin-docs directory](https://github.com/davidcansler/test-deployment/tree/main/admin-docs).
